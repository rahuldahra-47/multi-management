            ...
            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
              <div className="flex items-start">
                ...
                <div className="grow ml-6">
                  ...
                  <p className="text-gray-500">support@aiomanagement.com</p>
                  <p className="text-gray-500">+91 989634****</p>
                </div>
              </div>
            </div>
            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
              <div className="flex items-start">
                ...
                <div className="grow ml-6">
                  ...
                  <p className="text-gray-500">sales@aiomanagement.com</p>
                  <p className="text-gray-500">+91 749489****</p>
                </div>
              </div>
            </div>
            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
              <div className="flex align-start">
                ...
                <div className="grow ml-6">
                  ...
                  <p className="text-gray-500">feedback@aiomanagement.com</p>
                  <p className="text-gray-500">+91 893021****</p>
                </div>
              </div>
            </div>
            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
              <div className="flex align-start">
                ...
                <div className="grow ml-6">
                  ...
                  <p className="text-gray-500">bugs@aiomanagement.com</p>
                  <p className="text-gray-500">0130-8810****</p>
                </div>
              </div>
            </div>
          </div>
