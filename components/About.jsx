  ...
  return (
    <div>
         <div className="text-center ">
            <h2 className="text-5xl font-semibold tracking-tight text-gray-800 mt-10 sm:text-5xl" id="about">
              About us
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center md:flex-row justify-center">
            <div className="p-4">
              ...
              <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
                ...
                {/* <Link href="#">
                    <svg width="30" height="30" fill="currentColor" className="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-black" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="p-4">
              ...
              <div className="text-center">
                <p className="text-2xl text-gray-800 ">Harshit</p>
                <p className="text-xl font-light text-gray-500 ">
                  Front End Developer
                </p>
                <p className="max-w-xs py-4 font-light text-gray-500 text-md ">
